...
#SBATCH --job-name="Fullfield-T-West-T120"
...
cd applications/solvers/my_seaIce_06112024_v2
...
cd /scratch/mrqrut001/simulation/postdoc/Github/Fullfield case/Thermodynamics/West/T120
...
singularity exec $SINGULARITY_PATH/$CONTAINER_ID.sif bash -c "source $FOAM_BASHRC && mpirun -np 36 my_seaIce_06112024_v2 -parallel"
